    ...
    '<div class="pp-row pp-textfield">' +
      ...
      '<div class="pp-field-wrapper">' +
        '<select id="cam-script-format" name="scriptFormat" data-value>' +
          '<option value="http://www.w3.org/1999/XPath" selected>XPath 1.0</option>' +
          '<option value="http://www.java.com/java">Java</option>' +
          '<option value="http://www.mvel.org/2.0">MVEL 2.0</option>' +
          '<option value="http://www.javascript.com/javascript">JavaScript</option>' +
        '</select>' +
