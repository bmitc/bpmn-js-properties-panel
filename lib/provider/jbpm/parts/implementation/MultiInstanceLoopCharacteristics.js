...
/**
 * Get the 'jbpm:collection' attribute value of the loop characteristics.
 *
 * @param {djs.model.Base} element
 *
 * @return {string} the 'jbpm:collection' value
 */
function getCollection(element) {
  return getProperty(element, 'jbpm:collection');
}

/**
 * Get the 'jbpm:elementVariable' attribute value of the loop characteristics.
 *
 * @param {djs.model.Base} element
 *
 * @return {string} the 'jbpm:elementVariable' value
 */
function getElementVariable(element) {
  return getProperty(element, 'jbpm:elementVariable');
}
...
module.exports = function(element, bpmnFactory) {
  ...
  entries.push(entryFactory.textField({
    ...
    set: function(element, values) {
      ...
      return cmdHelper.updateBusinessObject(element, loopCharacteristics, {
        'jbpm:collection': values.collection || undefined
      });
    },
  ...
  entries.push(entryFactory.textField({
    ...
    set: function(element, values) {
      var loopCharacteristics = getLoopCharacteristics(element);
      return cmdHelper.updateBusinessObject(element, loopCharacteristics, {
        'jbpm:elementVariable': values.elementVariable || undefined
      });
    }
  }));
