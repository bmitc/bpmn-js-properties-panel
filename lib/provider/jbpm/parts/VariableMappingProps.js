...
/**
  * return depend on parameter 'type' jbpm:in or jbpm:out extension elements
  */
function getJBPMInOutMappings(element, type) {
...
function getVariableMappings(element, type) {
  var jbpmMappings = getJBPMInOutMappings(element, type);
  return filter(jbpmMappings, function(mapping) {
...
var CAMUNDA_IN_EXTENSION_ELEMENT = 'jbpm:In',
    CAMUNDA_OUT_EXTENSION_ELEMENT = 'jbpm:Out';
